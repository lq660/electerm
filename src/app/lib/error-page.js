...
function generateErrorHtml (port) {
  return `
    ...
    <body>
      <div class="section">
        <h1>Cloud Helm Workbench could not start its local service</h1>
        ...
        <p>Restart the app after making changes. If the problem persists, copy this page and send it to your product maintainer.</p>
      </div>
      ...
      <div class="section chinese">
        ...
        <p>更改设置后重启应用程序。如果问题仍然存在，请复制本页信息并交给产品维护人员。</p>
      </div>
    </body>
    </html>
  `
